...
media_path: "/assets/media/class"
---
<div class="content" markdown="1">

![Cover image for Class case study]({{ page.media_path }}/class-cover.png)
...
![Homework on papers]({{ page.media_path }}/class-01.png)

Class solves this problem. Students get homework &rarr; do&nbsp;it&nbsp;on&nbsp;paper &rarr; take pictures and send them to&nbsp;a&nbsp;teacher &rarr; the teacher reviews it&nbsp;and gives a&nbsp;mark.
...
<video autoplay muted loop playsinline preload="auto" class="case-hero">
  <source src="{{ page.media_path }}/class-07.mp4" type="video/mp4">
</video>

![Mobile interface for students]({{ page.media_path }}/class-02.png)
![Another view of mobile interface for students]({{ page.media_path }}/class-03.png)
...
![Initial desktop interface for teachers is a chat]({{ page.media_path }}/class-04.png)
...
![Teacher's UI design for managing tasks]({{ page.media_path }}/class-05.png)

The most significant part of&nbsp;the teacher's UI&nbsp;is&nbsp;a&nbsp;homework review:

![Homework review interface for teachers]({{ page.media_path }}/class-06.png)

Here the teacher can zoom photos:

<video autoplay muted loop playsinline preload="auto" class="case-hero">
  <source src="{{ page.media_path }}/class-08.mp4" type="video/mp4">
</video>

And gives marks:

<video autoplay muted loop playsinline preload="auto" class="case-hero">
  <source src="{{ page.media_path }}/class-09.mp4" type="video/mp4">
</video>
