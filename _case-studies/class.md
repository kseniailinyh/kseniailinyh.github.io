...
![Cover image for Class case study](class-cover.png)
...
![Homework on papers](class-01.png)
...
<video autoplay muted loop playsinline preload="auto" class="case-hero">
  <source src="class-07.mp4" type="video/mp4">
</video>

![Mobile interface for students](class-02.png)
![Another view of mobile interface for students](class-03.png)
...
![Initial desktop interface for teachers is a chat](class-04.png)
...
![Teacher's UI design for managing tasks](class-05.png)

The most significant part of&nbsp;the teacher's UI&nbsp;is&nbsp;a&nbsp;homework review:

![Homework review interface for teachers](class-06.png)

Here the teacher can zoom photos:

<video autoplay muted loop playsinline preload="auto" class="case-hero">
  <source src="class-08.mp4" type="video/mp4">
</video>
